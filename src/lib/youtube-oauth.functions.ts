...
// DEPRECATED: This function is no longer used. Use createYouTubeBroadcast from youtube-broadcast.functions.ts instead
// It was previously used for RTMP-based streaming, but has been replaced by LiveKit Egress workflow
