  ...
  return (
    <main className="min-h-screen bg-[#030712] text-slate-200 selection:bg-yellow-500/30 overflow-x-hidden relative font-sans antialiased">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-12 relative z-10">
        ...
        {/* Updated: Premium Glassmorphic Streaming Gateways Section */}
        <section className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-gradient-to-b from-white/[0.02] to-transparent p-6 shadow-xl backdrop-blur-md">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/[0.01] via-transparent to-transparent pointer-events-none" />
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/[0.06] pb-5 mb-5">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-b from-yellow-500/10 to-amber-500/5 border border-yellow-500/20 text-yellow-400 shadow-[0_0_15px_rgba(234,179,8,0.05)]">
                <Radio className="w-4 h-4" />
              </div>
              <div>
                <h2 className="font-semibold text-sm tracking-wide text-white uppercase font-mono">Streaming Gateways</h2>
                <p className="text-xs text-slate-400 mt-0.5">Stream infrastructure links and ingest routes.</p>
              </div>
            </div>
            <div className="scale-95 sm:scale-100 origin-right transition-transform">
              <YouTubeCreateMenu
          ...
          {youtubeConnected && connectedChannel ? (
            <div className="p-[1px] rounded-[16px] bg-gradient-to-b from-white/[0.08] to-transparent shadow-lg transition-all duration-300">
              <div className="bg-[#050a17]/80 rounded-[15px] p-2 backdrop-blur-2xl border border-white/[0.02]">
                <YouTubeChannelStats channel={connectedChannel} />
              </div>
            </div>
          ) : (
            <div className="flex flex-col items-center justify-center p-8 text-center rounded-xl bg-neutral-950/30 border border-white/[0.02] border-dashed">
              <p className="text-xs text-slate-400 font-medium tracking-wide">No active ingest gateways connected.</p>
              <p className="text-[11px] text-slate-500 mt-1 max-w-xs">Connect your platform channel above to deploy edge nodes and streaming pipelines.</p>
            </div>
          )}
        </section>
        ...
        {/* Updated: Premium Glassmorphic Automation Infrastructure Section */}
        <section className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-gradient-to-b from-white/[0.01] to-transparent p-6 shadow-xl backdrop-blur-md">
          <div className="absolute inset-0 bg-gradient-to-b from-yellow-500/[0.01] via-transparent to-transparent pointer-events-none" />
          <div className="flex items-center gap-3 border-b border-white/[0.06] pb-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Automated video parsing, metadata extraction, and workflow engines.</p>
            </div>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="group relative rounded-xl border border-white/[0.05] bg-neutral-950/40 p-5 transition-all duration-300 hover:border-white/[0.08] hover:bg-neutral-950/60 shadow-lg">
            ...
            <div className="group relative rounded-xl border border-white/[0.05] bg-neutral-950/40 p-5 transition-all duration-300 hover:border-white/[0.08] hover:bg-neutral-950/60 shadow-lg">
              <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-amber-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
